...
enum IndexCatalog {
    ...
    static let defaults: [IndexDescriptor] = [
        ...
        IndexDescriptor(id: "SH000688", nameZh: "科创50",     nameEn: "SSE STAR Market 50",       market: .a, emSecid: "1.000688", tencentCode: "sh000688", currency: .cny),
        IndexDescriptor(id: "SH000300", nameZh: "沪深300",    nameEn: "CSI 300",        market: .a,  emSecid: "1.000300", tencentCode: "sh000300", currency: .cny),
        IndexDescriptor(id: "SH000852", nameZh: "中证1000",   nameEn: "CSI 1000",                market: .a, emSecid: "1.000852", tencentCode: "sh000852", currency: .cny),
